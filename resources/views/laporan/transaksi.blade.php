...
@section('header', 'Laporan Transaksi Zakat')
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('admin.laporan.transaksi') }}" method="GET" class="row align-items-end">
            ...
            <div class="col-md-4 mb-3">
                ...
                <a href="{{ route('admin.laporan.transaksi.cetak', ['start_date' => $startDate, 'end_date' => $endDate]) }}" target="_blank" class="btn btn-success"><i class="bi bi-printer"></i> Cetak PDF</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h6 class="m-0 font-weight-bold text-primary">Data Transaksi ({{ date('d M Y', strtotime($startDate)) }} - {{ date('d M Y', strtotime($endDate)) }})</h6>
        <span class="badge bg-success fs-6">Total: Rp {{ number_format($totalNominal, 0, ',', '.') }}</span>
    </div>
    <div class="card-body">
